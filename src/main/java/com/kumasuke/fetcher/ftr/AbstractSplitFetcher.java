 ...
 *
 * @param <T> {@code SongPageParser} 对象，用于获取歌曲基本信息
 * @param <U> {@code LyricsParser} 对象，用于获取歌词文本
 */
abstract class AbstractSplitFetcher<T extends SongPageParser, U extends LyricsParser> implements Fetcher {
    T songPageParser;
    U lyricsParser;
